...
public class FirstActivityShowMap extends PermissionsActivity implements View.OnClickListener,LocationSource,AMapLocationListener {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener(){
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_user:
                        //启动登录注册界面
                        startActivity(new Intent(FirstActivityShowMap.this,LogIn.class));
                        break;
    ...
    private void CreateDataBase(){
         ...
         * sql语句
         */
//        String inserthistorysql = "insert into historytable(data,startpos,endpos,startweather,endweather,totaltime) values(?,?,?,?,?,?)";
//        String selecthistorysql = "select * from historytable";
////        String deletehistorysql = "delete from history where data = ? and startpos = ? endpos = ? "
//        String insertusersql = "insert into usertable(username,userpsd) values(?,?)";
//        String selectusersql = "select * from usertable";
//
//        MyDataBase myDataBaseHelper = new MyDataBase(FirstActivityShowMap.this,"ApplicationDataBase.db",null,1);
//        SQLiteDatabase db = myDataBaseHelper.getWritableDatabase();
//
//        db.execSQL(inserthistorysql,new String[] {"2019/03/05","深圳","北京","晴天","小雪","2day6h40min"});
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        if (mListener!=null && aMapLocation!=null)  //aMapLocation是定位的结果类
        {
            ...
            if (aMapLocation.getErrorCode() == 0) {//解析aMapLocation获取相应内容
                ...
                //定位失败
                Toast.makeText(FirstActivityShowMap.this,"似乎出了什么问题..." , Toast.LENGTH_SHORT).show();
            }
        }
    }
    @Override
